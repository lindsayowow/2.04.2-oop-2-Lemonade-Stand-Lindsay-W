...
public class LemonadeStand {
    ...
    // This method should create a new Lemonade object with the given arguments and then attempt to make
    // the lemonade.
    // If the lemonade is successfully made, the method should add the sale amount to the money field and
    // return true.
    //
    // HINT: You can copy and paste the body of the sellLemonade method and should only need to modify the
    // first line.
